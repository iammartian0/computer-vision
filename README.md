This is edited [notebook](https://www.kaggle.com/code/jhoward/is-it-a-bird-creating-a-model-from-your-own-data) from the course [Practical deeplearning for coders](https://course.fast.ai/).
